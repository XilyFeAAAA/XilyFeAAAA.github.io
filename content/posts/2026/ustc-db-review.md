...
tags:
  - 数据库
  - 复习
lastmod: 2026-01-16T11:18:33+08:00
---
...
```text
1、已知有关系模式R(A,B,C)和S(B,C,D),每个属性都占10个字节，请估计下面的逻辑查询计划的T(U),S(U)以及结果关系中每个属性的V值（假设满足“Containment of ValueSets",并且选择条件中的值都在关系中存在)：
